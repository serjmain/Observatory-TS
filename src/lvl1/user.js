...
var User = /** @class */ (function () {
    ...
    User.prototype.buyExcursionAsyncPromise = function (observatoryName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            setTimeout(function () {
                if (!_this.observatoryList.length) {
                    reject(new Error("no available excursion"));
                }
                var observatory = _this.observatoryList.find(function (_a) {
                    var name = _a.name, excursionPrice = _a.excursionPrice;
                    return name === observatoryName && _this.cardBalance >= excursionPrice;
                });
                if (observatory) {
                    _this._cardBalance = _this.cardBalance - observatory.excursionPrice;
                    _this._boughtExcursions.push(observatoryName);
                    resolve({ boughtExcursions: _this._boughtExcursions, cardBalance: _this._cardBalance });
                }
